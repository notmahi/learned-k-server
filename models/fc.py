...
class FCModel(nn.Module):
    ...
    def _build_layers(self):
        ...
        for i in range(self.num_layers):
            self.layers += [nn.Linear(self.hidden_dim, self.hidden_dim), self.first_layer, nn.ReLU(), nn.BatchNorm1d(self.hidden_dim)]
    ...
    def forward(self, req_sequence):
        self.model(req_sequence.view(self.input_dim, -1))
